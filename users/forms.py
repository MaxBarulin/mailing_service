...
class ProfileForm(FormClean, forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs.update(
            {"class": "form-control", "placeholder": "Придумайте имя пользователя", "help_text": "!@@@@@"}
        )
...
class LoginUserForm(AuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs.update({"class": "form-control", "placeholder": "Введите ваш email"})
