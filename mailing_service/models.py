...
class UserMail(models.Model):
    ...
    email = models.EmailField(unique=True, max_length=150, verbose_name="Email")  # столбцы таблицы
    fullname = models.CharField(max_length=250, verbose_name="Ф.И.О.", null=False, blank=False)
    comment = models.TextField(verbose_name="Комментарий", null=True, blank=True)
    owner = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, related_name="UserMail", blank=True, null=True, verbose_name="Владелец"
    )
...
class Message(models.Model):
    ...
    owner = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, related_name="Message", blank=True, null=True, verbose_name="Владелец"
    )
...
class Mailing(models.Model):
    ...
    owner = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, related_name="Mailing", blank=True, null=True, verbose_name="Владелец"
    )
